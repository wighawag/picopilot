...
3. Sprites/art: edit as a char grid with `node __PICOPILOT__ gfx set <n>`, and LOOK at it with `node __PICOPILOT__ gfx render <n>` (it writes a PNG you can view). Fix in that loop.

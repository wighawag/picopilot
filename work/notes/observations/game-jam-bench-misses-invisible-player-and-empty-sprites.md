...
> PROMOTED 2026-07-06: the verified transform + transport facts below are now a proper finding with a `source:` line, `work/notes/findings/pico8-drive-capture-transform-and-block-transport.md`, and are built into the tested `picopilot playtest` command (ADR-0011). Cite the finding, not this observation, for the ground truth.

...
>
> EXPANDABLE (note, not this task): a future iteration could auto-inject/strip a standard screenshot+sentinel harness into the cart so the agent doesn't add debug lines by hand. Keep the design open to that; don't build it now.
